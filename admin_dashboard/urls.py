...
urlpatterns = [
  ...
  path('jobprofile/details/<str:card_number>/', views.JobprofileDetailsOfMember.as_view(), name='jobprofile-details'),
  ...
  path('institute/details/<str:business_id>/', staff_api.InstitutedetailsApi.as_view(), name='institute-details'),
